<template>
  ...
  <form  class="d-flex flex-column">
    <div class="form-floating h-100 d-flex flex-column flex-grow-1 ps-2 pt-0 mx-2 mb-2 mt-0">
      <textarea class="form-control pastearea flex-grow-1" placeholder="" name="teamPasteArea"></textarea>
      <label for="teamPasteArea">Paste your team</label>
    </div>

    <div class="d-flex align-items-center justify-content-around">

      <button @click="" type="button" class="btn btn-success form-control w-25">Submit</button>
